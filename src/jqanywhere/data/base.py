...
class MarketDataProvider(ABC):
    ...
    def get_price(self, security, *args, **kwargs):
        ...
        """
        raise NotImplementedError("JQAnywhere v0.6 does not implement get_price for this data provider")
    ...
    def get_index_stocks(self, index_symbol: str, date=None) -> list[str]:
        ...
        """
        raise NotImplementedError("JQAnywhere v0.6 does not implement get_index_stocks for this data provider")

    def get_all_securities(self, types=None, date=None):
        """Return security metadata as a JoinQuant-style DataFrame indexed by code."""
        raise NotImplementedError("JQAnywhere v0.6 does not implement get_all_securities for this data provider")

    def get_security_info(self, code: str) -> SecurityInfo:
        """Return one security's JoinQuant-style metadata object."""
        raise NotImplementedError("JQAnywhere v0.6 does not implement get_security_info for this data provider")
    ...
    def get_trade_days(self, start_date=None, end_date=None, count=None) -> list[date]:
        ...
        raise NotImplementedError("JQAnywhere v0.6 does not implement get_trade_days for this data provider")
